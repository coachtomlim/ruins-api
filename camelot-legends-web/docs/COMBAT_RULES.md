...
- Rallying survivors in area 003 grants 10 XP, restores 4 MP, and unlocks a stronger scout approach choice.
- Searching survivor supplies grants 5 XP and a Potion.
- Moving on cautiously grants 2 guard.
- Scouting the castle approach determines the battle opening.
...
- `Approach Openly`: start battle with 1 guard.
- `Take Cover and Observe`: start battle with 4 guard.
- `Prepare Equipment`: restore 4 MP and start battle with 3 guard.
- `Use Survivor Information`: requires survivor information, starts battle with 6 guard, and makes the enemy open defensively.
