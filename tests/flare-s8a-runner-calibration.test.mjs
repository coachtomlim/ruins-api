...
test('progressed runner snapshot exposes effective stats to calibration',()=>{
  const snap=createRunnerSnapshot({runnerId:'r1',runnerName:'Warrior',runnerLevel:2,baseRunner:{hp:100,attack:12,defense:1},progression:{statBonuses:{hp:10},equipment:{weapon:{id:'blade',slot:'weapon',modifiers:{attack:3}},chest:{id:'mail',slot:'chest',modifiers:{defense:2}}}},rulesVersion:'rv',contentVersion:'cv'});
