#!/usr/bin/env python3
"""Deploy WEB-FLARE S4 beside frozen S2/S3 builds.
...
Writes only to:
  ...
  public_html/q
It never writes flare-s2, flare-s3, or flare-p0.
The /q/XXXX route is repointed to the S4 player, whose decoder preserves legacy S3 codes.
"""
...
ALLOWED=(S4_ROOT,SHORT_ROOT)
FILES=['public/flare-s4/index.html','public/flare-s4/builder.mjs','public/flare-s4/flow.mjs','public/flare-s4/game.mjs','public/flare-s4/simulation.mjs','public/flare-s4/renderer.mjs','public/flare-s4/play.html','public/flare-s4/play.mjs','public/flare-s4/style.css','public/flare-s4/data/game.json']
HTACCESS='''DirectoryIndex index.html\nAddDefaultCharset UTF-8\nAddType text/html .html\nAddType text/css .css\nAddType text/javascript .js .mjs\nAddType application/json .json\n<IfModule mod_headers.c>\nHeader set X-Content-Type-Options "nosniff"\n</IfModule>\n'''
SHORT_HTACCESS='''RewriteEngine On\nRewriteRule ^([A-Za-z0-9_-]{4})/?$ /quick-dungeon/flare-s4/play.html [L]\nOptions -Indexes\n'''
...
def main():
 verify_source();uapi('Fileman','list_files',{'dir':'public_html'});ensure_dir(S4_ROOT);ensure_dir(SHORT_ROOT);save(f'{S4_ROOT}/.htaccess',HTACCESS);save(f'{SHORT_ROOT}/.htaccess',SHORT_HTACCESS)
 for rel in FILES:
  local=REPO_ROOT/rel
