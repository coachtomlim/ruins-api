...
SOURCE_SHA = 'e320917a49f35a71cf00033f7c31842da1e9b93a'
PREVIOUS_SHA = 'e6a8e3a4dbe2570fd53b438cfc027a45f95eba76'
...
EXPECTED_ROOT_NAMES = {
    ...
    'config.js','index.html','stat-purchase-flow.mjs','supabase-browser.mjs','vendor'
}
...
def headers() -> dict[str, str]:
    ...
    return {
        ...
        'User-Agent': 'QuickDungeonS8BUpdate/2.0',
...
def main() -> None:
    ...
    if mode not in {'auth', 'probe', 'deploy'}:
        fail('usage: hostgator-flare-s8b-update-002.py auth|probe|deploy')
